...
|**区域**|**任务**|
|:-----|:-----|
|了解 ISO 27001 管理和合规性要求。|•    使用[合规性管理器](https://docs.microsoft.com/microsoft-365/compliance/compliance-manager)来评估和管理合规性风险，以对组织执行 ISO 27001:2013 评估。为全部 14 个 ISO 27001 组制定标准操作过程 (SOP)。
