...
Microsoft 的响应重点关注两个风险最高的类别。 尽管任何风险类别均不禁止云服务，但 A从而希望您采取明显更高的监管级别，并且随着风险类别的增加，您应该会逐渐增加 A从而进行 A从而进行审核。 A OUTSOURCING 列出了一系列因素，这些因素通常指示云外包的高或极端固有风险。 Microsoft 深入解决了其中每个因素，提供了一些信息和工具，可帮助你评估和管理将数据和工作负载迁移到 Azure 的风险。
...
APRA [审慎标准 CPS 234 信息安全](https://www.legislation.gov.au/Details/F2018L01745) 要求受监管机构：
...
Microsoft 云服务：遵守[A且谨慎标准 CPS 234 信息安全](https://query.prod.cms.rt.microsoft.com/cms/api/am/binary/RE2OsZg)规定了每项相关的 CPS 234 监管义务，并针对它映射了 Microsoft 云服务控制、功能、功能、合同承诺和支持信息，以帮助受 ASO 监管的实体遵守 CPS 234 规定的监管义务。
...
此 Microsoft 清单介绍了金融公司在迁移到云时必须解决的 A CHECKLIST 法规要求。 它不仅将 Azure 映射到审慎标准 [CPS 231 外包](https://www.apra.gov.au/sites/default/files/Prudential-Standard-CPS-231-Outsourcing-%28July-2017%29.pdf)，还映射了其他相关的 A OUTSOURCING 标准，如业务连续性和风险管理标准。 完成此清单可帮助你的金融服务机构采用 Azure，并置信于它满足相关的 A CHECKLIST 要求。
