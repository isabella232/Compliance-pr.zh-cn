...
|**区域**|**任务**|
|:-----|:-----|
|了解 NIST 800-53 要求，并考虑与 Microsoft 咨询合作伙伴合作。|•    与 Microsoft 合作伙伴合作，共同对组织执行 NIST 800-53 合规性差距分析，并绘制合规性路线图。 <br>•   遵循 [Microsoft 合规性管理器](https://docs.microsoft.com/microsoft-365/compliance/compliance-manager)中的指导，定义和记录与访问控制和信息共享相关的策略和过程，这些策略和过程涉及到目标、范围、角色、责任、组织实体之间的协作和合规性。|
