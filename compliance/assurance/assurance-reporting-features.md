...
| [邮箱内容搜索和保留](https://docs.microsoft.com/exchange/security-and-compliance/in-place-ediscovery/in-place-ediscovery) | 提供对邮箱 In-Place 电子数据展示或 In-Place 保留设置所做的任何更改的详细信息。 |
